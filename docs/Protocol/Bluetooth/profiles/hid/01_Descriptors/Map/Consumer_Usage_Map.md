---
title: Consumer Page Usage Map
tags: [HID, Usage-Table, Consumer]
...
| **65** | Snapshot | OSC |  |
| **66** | Still | OSC |  |
| **67** | Picture-in-Picture Toggle [8] | OSC |  |
| **68** | Picture-in-Picture Swap [8] | OSC |  |
| **69** | Red Menu Button [9] | MC |  |
| **6A** | Green Menu Button [9] | MC |  |
| **6B** | Blue Menu Button [9] | MC |  |
| **6C** | Yellow Menu Button [9] | MC |  |
| **6D** | Aspect [10] | OSC |  |
| **6E** | 3D Mode Select [11] | OSC |  |
| **6F** | Display Brightness Increment [14] | RTC |  |
| **70** | Display Brightness Decrement [14] | RTC |  |
| **71** | Display Brightness [14] | LC |  |
| **72** | Display Backlight Toggle [14] | OOC |  |
| **73** | Display Set Brightness to Minimum [14] | OSC |  |
| **74** | Display Set Brightness to Maximum [14] | OSC |  |
| **75** | Display Set Auto Brightness [14] | OOC |  |
| **76** | Camera Access Enabled [41] | OOC |  |
| **77** | Camera Access Disabled [41] | OOC |  |
| **78** | Camera Access Toggle [41] | OOC |  |
| **79** | Keyboard Brightness Increment [42] | OSC |  |
| **7A** | Keyboard Brightness Decrement [42] | OSC |  |
| **7B** | Keyboard Backlight Set Level [42] | LC |  |
| **7C** | Keyboard Backlight OOC [42] | OOC |  |
| **7D** | Keyboard Backlight Set Minimum [42] | OSC |  |
| **7E** | Keyboard Backlight Set Maximum [42] | OSC |  |
| **7F** | Keyboard Backlight Auto [42] | OOC |  |
| **80** | Selection | NAry |  |
...
| **D0** | Invoke Capture Interface [35] | Sel |  |
| **D1** | Start or Stop Game Recording [35] | Sel |  |
| **D2** | Historical Game Capture [35] | Sel |  |
| **D3** | Capture Game Screenshot [35] | Sel |  |
| **D4** | Show or Hide Recording Indicator [35] | Sel |  |
| **D5** | Start or Stop Microphone Capture [35] | Sel |  |
| **D6** | Start or Stop Camera Capture [35] | Sel |  |
| **D7** | Start or Stop Game Broadcast [35] | Sel |  |
| **D8** | Start or Stop Voice Dictation Session [66] | OOC |  |
| **D9** | Invoke/Dismiss Emoji Picker [68] | OOC |  |
| **DA-DF** | Reserved |  |  |
| **E0** | Volume | LC |  |
| **E1** | Balance | LC |  |
| **E2** | Mute | OOC |  |
...
| **1C8** | AL Message Status [5] | Sel |  |
| **1C9** | AL Contact Sync [5] | Sel |  |
| **1CA** | AL Navigation [64] | Sel |  |
| **1CB** | AL Context-aware Desktop Assistant [56] | Sel |  |
| **1CC-1FF** | Reserved |  |  |
...
| **29D** | AC Next Keyboard Layout Select [28] | Sel |  |
| **29E** | AC Navigation Guidance [44] | Sel |  |
| **29F** | AC Desktop Show All Windows [46] | Sel |  |
| **2A0** | AC Soft Key Left [5] | Sel |  |
| **2A1** | AC Soft Key Right [5] | Sel |  |
| **2A2** | AC Desktop Show All Applications [64] | Sel |  |
| **2A3-2AF** | Reserved |  |  |
| **2B0** | AC Idle Keep Alive [5] | Sel |  |
| **2B1-2BF** | Reserved |  |  |
| **2C0** | Extended Keyboard Attributes Collection [15] | CL |  |
| **2C1** | Keyboard Form Factor [15] | SV |  |
| **2C2** | Keyboard Key Type [15] | SV |  |
| **2C3** | Keyboard Physical Layout [15] | SV |  |
| **2C4** | Vendor-Specific Keyboard Physical Layout [15] | SV |  |
| **2C5** | Keyboard IETF Language Tag Index [15] | SV |  |
| **2C6** | Implemented Keyboard Input Assist Controls [15] | SV |  |
| **2C7** | Keyboard Input Assist Previous [15] | Sel |  |
| **2C8** | Keyboard Input Assist Next [15] | Sel |  |
| **2C9** | Keyboard Input Assist Previous Group [15] | Sel |  |
| **2CA** | Keyboard Input Assist Next Group [15] | Sel |  |
| **2CB** | Keyboard Input Assist Accept [15] | Sel |  |
| **2CC** | Keyboard Input Assist Cancel [15] | Sel |  |
| **2CD-2CF** | Reserved |  |  |
| **2D0** | Privacy Screen Toggle [62] | OOC |  |
| **2D1** | Privacy Screen Level Decrement [62] | RTC |  |
| **2D2** | Privacy Screen Level Increment [62] | RTC |  |
| **2D3** | Privacy Screen Level Minimum [62] | OSC |  |
| **2D4** | Privacy Screen Level Maximum [62] | OSC |  |
| **2D5-4FF** | Reserved |  |  |
| **500** | Contact Edited [5] | OOC |  |
| **501** | Contact Added [5] | OOC |  |
| **502** | Contact Record Active [5] | OOC |  |
| **503** | Contact Index [5] | DV |  |
| **504** | Contact Nickname [5] | DV |  |
| **505** | Contact First Name [5] | DV |  |
| **506** | Contact Last Name [5] | DV |  |
| **507** | Contact Full Name [5] | DV |  |
| **508** | Contact Phone Number Personal [5] | DV |  |
| **509** | Contact Phone Number Business [5] | DV |  |
| **50A** | Contact Phone Number Mobile [5] | DV |  |
| **50B** | Contact Phone Number Pager [5] | DV |  |
| **50C** | Contact Phone Number Fax [5] | DV |  |
| **50D** | Contact Phone Number Other [5] | DV |  |
| **50E** | Contact Email Personal [5] | DV |  |
| **50F** | Contact Email Business [5] | DV |  |
| **510** | Contact Email Other [5] | DV |  |
| **511** | Contact Email Main [5] | DV |  |
| **512** | Contact Speed Dial Number [5] | DV |  |
| **513** | Contact Status Flag [5] | DV |  |
| **514** | Contact Misc. [5] | DV |  |
| **515** | Keyboard Brightness Next [84] | OSC |  |
| **516** | Keyboard Brightness Previous [84] | OSC |  |
| **517** | Keyboard Backlight Level Suggestion [84] | SV |  |
| **518-FFFF** | Reserved |  |  |
| **3D** | Mode Select OSC Selects the next available supported 3D mode on a TV or | other |  |
